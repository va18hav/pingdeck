                ...
                <div className="flex-1 p-8 sm:p-12 md:p-16 flex flex-col justify-center relative bg-white">
                    <div className="w-full max-w-sm mx-auto space-y-6">
                        ...
                        <div className="hidden lg:block space-y-1">
                            <h2 className="text-2xl font-extrabold tracking-tight text-slate-900 font-sans">Create Account</h2>
                            <p className="text-xs text-slate-500 font-medium">Get started with automated uptime checking</p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                >
                                    ...
                                    <span className="text-slate-700 font-sans">Sign up with Google</span>
                                </button>
